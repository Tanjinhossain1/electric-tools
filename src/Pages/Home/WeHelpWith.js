...
const WeHelpWith = () => {
    ...
    return (
        <div   className='mt-32'>
            <h1 className='text-4xl text-center font-bold text-[#1a2333] '>What Can We Help You With?</h1>
                ...
                <div className='lg:flex justify-around '>
                    <div>
                        <div data-aos-delay="300" data-aos="fade-right" className='text-center'>
                            ...
                            <p className='text-xl font-bold my-4 text-[#1a2333]' >Energy</p>
                            <p className='w-3/4 mx-auto text-[#6e6e6e]'>See our energy products and services available to you.</p>
                        </div>
                        <div data-aos-delay="300" data-aos="fade-up" className='text-center mt-12'>
                            ...
                            <p className='text-xl font-bold my-4 text-[#1a2333] ' >Home Services</p>
                    ...
                    <div>
                        <div data-aos-delay="200" data-aos="fade-up" className='text-center'>
                            ...
                            <p className='text-xl font-bold my-4 text-[#1a2333] ' >Smart Homes
                            </p>
                            <p className='w-3/4 mx-auto text-[#6e6e6e]'>Enjoy the benefits of smart meters and find out more about smart products.
                        ...
                        <div data-aos-delay="300" data-aos="fade-left" className='text-center mt-12'>
                            ...
                            <p className='text-xl font-bold my-4 text-[#1a2333] ' >Help & Support
                            </p>
                            <p className='w-3/4 mx-auto text-[#6e6e6e]'> Choose a category to find the best way to contact us.
            ...
            <div className='bg-[#ffe700] py-12'>
               ...
               <p data-aos-delay="300" data-aos="fade-right" className='text-2xl font-semibold text-blue-900'>Looking For A Qulity And Afffordable For Your Next Trouble?</p>
