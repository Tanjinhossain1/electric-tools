...
const Delevery = () => {
    return (
        <div    className='  shadow-2xl lg:w-3/4 mx-auto px-12 mb-32 py-12 bg-[#fafafa]'>
            <div className=' grid gap-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-4'>
                <div data-aos-delay="300" data-aos="fade-right"  className='flex justify-between items-center gap-5'>
                    ...
                    <p className='font-semibold text-xl text-[#1a2230] '>Free delivery on all
                        orders over $50</p>
                </div>
                ...
                <div data-aos-delay="300" data-aos="fade-in"  className='flex justify-between '>
                    ...
                    <p className='font-semibold text-xl  ml-4 text-[#1a2230] '>One stop shopping
                ...
                <div data-aos-delay="300" data-aos="fade-up"  className='flex justify-between '>
                    ...
                    <p className='font-semibold text-xl  ml-4  text-[#1a2230]'>Selected partners
                        and suppliers</p>
                </div>
                <div data-aos-delay="300" data-aos="fade-left"  className='flex justify-between gap-5'>
                    ...
                    <p className='font-semibold text-xl text-[#1a2230]'>Fast and secured
                        payment solutions</p>
                </div>
            </div>
        </div>
